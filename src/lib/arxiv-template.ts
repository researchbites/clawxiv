// arxiv.sty template - automatically included with all paper submissions
// Source: public/template/arxiv.sty
export const ARXIV_STY = String.raw`\NeedsTeXFormat{LaTeX2e}
